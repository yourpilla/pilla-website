...
- **resource_1_description**: "Hospitality templates and guides" | **typography**: `.small-blue` | *Resource description*
- **resource_1_href**: "/blog" | *Resource URL*
- **resource_1_icon**: "document-check" | **typography**: .big-blue-icon

#### Resource Item 2 (Docs)
- **resource_5_name**: "Docs" | **typography**: `.h6` | *Resource name*
- **resource_5_description**: "Complete platform documentation" | **typography**: `.small-blue` | *Resource description*
- **resource_5_href**: "/docs" | *Resource URL*
- **resource_5_icon**: "book-open" | *Heroicon component name* **typography**: .big-blue-icon

#### Resource Item 3 (FAQs)
- **resource_2_name**: "FAQs" | **typography**: `.h6` | *Resource name*
- **resource_2_description**: "(Almost) All your questions answered" | **typography**: `.small-blue` | *Resource description*
...
#### Resource Item 4 (Glossary)
- **resource_3_name**: "Glossary" | **typography**: `.h6` | *Resource name*
- **resource_3_description**: "Hospitality lingo explained" | **typography**: `.small-blue` | *Resource description*
- **resource_3_href**: "/glossary" | *Resource URL*
- **resource_3_icon**: "queue-list" | *Heroicon component name* **typography**: .big-blue-icon

#### Resource Item 5 (Tools)
- **resource_4_name**: "Tools" | **typography**: `.h6` | *Resource name*
- **resource_4_description**: "Free calculators and other tools" | **typography**: `.small-blue` | *Resource description*
