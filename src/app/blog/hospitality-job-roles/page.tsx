...
export default function HospitalityJobRolesPage() {
  return (
    <div className="bg-main py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h1 className="h1">Hospitality Job Roles</h1>
          <p className="mt-2 big-blue">Complete job descriptions, role responsibilities, and career guidance for hospitality positions from entry-level to management.</p>
        </div>
