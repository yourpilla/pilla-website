    ...
    <div className="bg-main py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-2 big-blue">Operational excellence strategies, management systems, and efficiency improvements for hospitality and restaurant businesses.</p>
        </div>
