...
export default function RestaurantStaffOnboardingPage() {
  return (
    <div className="bg-main py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h1 className="h1">Restaurant Staff Onboarding</h1>
          <p className="mt-2 big-blue">Comprehensive onboarding guides, training programs, and best practices for successfully integrating new restaurant and hospitality staff.</p>
        </div>
        <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {posts.map((post) => (
            <Link key={post.id} href={post.href} className="flex max-w-xl flex-col items-start justify-between relative white-card p-6 group hover:shadow-sm transition-shadow">
              ...
              <div className="relative grow">
                ...
                <p className="mt-5 line-clamp-3 small-blue">{post.description}</p>
              </div>
            </Link>
          ))}
        </div>
