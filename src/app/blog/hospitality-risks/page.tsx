...
export default function HospitalityRisksPage() {
  return (
    <div className="bg-main py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h1 className="h1">Hospitality Risks</h1>
          <p className="mt-2 big-blue">Risk management strategies, safety protocols, and prevention measures to protect guests, staff, and your hospitality business.</p>
        </div>
